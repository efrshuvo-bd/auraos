//! Exception vectors and EL0 SVC handling.
...
pub unsafe extern "C" fn exception_vectors() {
    naked_asm!(
        ...
        "b {el1_unhandled}",
        ".align 7",
        // Lower EL using AArch64 — sync (SVC)
        "b {el0_sync}",
        ".align 7",
        "b {el1_unhandled}",
        ".align 7",
...
/// Save EL0 context on the EL1 stack, handle SVC, then eret or return to scheduler.
#[unsafe(naked)]
...
pub fn init() {
    ...
    console::println("exception: VBAR_EL1 installed (SVC ready)");
}
